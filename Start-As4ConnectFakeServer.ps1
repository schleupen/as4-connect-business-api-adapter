...
Write-Output "found: '$($json.name)' [tag: $($json.tag_name)] published_at '$($json.published_at)'"
...
ls -fi .\Schleupen.AS4.MSH.BusinessAPI.FakeServer.exe | % {  Write-Host $_.versioninfo }
